...
namespace estate_executor {
    ...
    int assemble_code(){
        int r = garcia::red::code_fragment() + khan::red::code_fragment() + zhang::red::code_fragment();
        int b = garcia::blue::code_fragment() + khan::blue::code_fragment() + zhang::blue::code_fragment();
        return r * b;
    }
